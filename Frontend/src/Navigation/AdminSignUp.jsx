         ...
         const AdminSignUp = () => {
           ...
           // Auto-generate Team ID on component mount
           useState(() => {
             setFormData((prev) => ({
               ...prev,
           ...
           const handleRegenerateTeamId = () => {
             setFormData((prev) => ({
               ...prev,
               teamId: generateTeamId(),
             }));
             setSuccess("✓ New Team ID generated!");
           ...
           const handleSubmit = async (e) => {
             ...
             try {
               ...
               if (error.message.includes("Team ID already exists")) {
                 setError(
                   "This Team ID is already taken. Please generate a new one."
                 );
                 handleRegenerateTeamId();
               ...
               <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
                 <div className="text-center bg-gray-800 rounded-2xl p-8 border border-gray-700">
                   ...
                   <div className="bg-yellow-500 bg-opacity-10 border border-yellow-500 rounded-lg p-4">
                     ...
                     <p className="text-yellow-500 text-2xl font-bold font-mono">
                       {formData.teamId}
                     </p>
                   ...
                   <div className="space-y-6">
                     <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
                       ...
                       <p className="text-gray-400">
                         Access all system features including grading,
                         announcements, and student management.
                       </p>
                     </div>
                     <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
                       <div className="w-12 h-12 bg-yellow-500 bg-opacity-20 rounded-xl flex items-center justify-center mb-4">
                       ...
                       <p className="text-gray-400">
                         Monitor student progress, attendance, and performance
                 ...
                 <div className="w-full">
                   <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-2xl">
                     ...
                     <form onSubmit={handleSubmit} className="space-y-5">
                       ...
                       <div>
                         <label className="block text-gray-400 text-sm font-medium mb-2">
                           Your Unique Team ID (Auto-generated) *
                         </label>
                         <div className="flex space-x-2">
                           <div className="relative flex-1">
                             ...
                             <input
                               ...
                               readOnly
                               className="w-full bg-gray-900 text-white border border-green-500 rounded-lg pl-12 pr-4 py-3 outline-none font-mono text-yellow-500"
                             />
                           </div>
                           <button
                             type="button"
                             onClick={handleRegenerateTeamId}
                       ...
                       <div className="bg-yellow-500 bg-opacity-10 border border-yellow-500 rounded-lg p-4 flex items-start space-x-3">
                         ...
                         <div>
                           ...
                           <p className="text-gray-400 text-xs">
                             Admin accounts have elevated privileges. Keep your
                             credentials secure and share your Team ID only with
                             authorized students.
                           </p>
                         </div>
                       </div>
