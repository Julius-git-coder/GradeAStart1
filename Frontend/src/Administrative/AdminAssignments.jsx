    ...
    <div className="space-y-6 p-4 sm:p-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold px-4 sm:px-6 py-3 rounded-lg flex items-center justify-center space-x-2 transition-colors w-full sm:w-auto"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <FileText className="w-10 h-10 sm:w-12 sm:h-12 text-yellow-500 opacity-20" />
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <Clock className="w-10 h-10 sm:w-12 sm:h-12 text-green-500 opacity-20" />
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-xs sm:text-sm">Team Students</p>
              <p className="text-white text-2xl sm:text-3xl font-bold mt-1">
                {students.length}
              </p>
            </div>
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-700">
        ...
        {assignments.length === 0 ? (
          <div className="p-8 sm:p-12 text-center">
            ...
            <button
              onClick={() => setShowCreateModal(true)}
              className="mt-4 bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold px-4 sm:px-6 py-3 rounded-lg inline-flex items-center justify-center space-x-2 transition-colors mx-auto"
            >
              <Plus className="w-5 h-5" />
                  ...
                  <div className="flex items-start justify-between gap-4 sm:gap-0">
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                        ...
                        {overdue ? (
                          <span className="bg-red-500 bg-opacity-20 text-white text-xs font-semibold px-2 sm:px-3 py-1 rounded-full">
                            Overdue
                          </span>
                        ) : (
                          <span className="bg-green-500 bg-opacity-20 text-white text-xs font-semibold px-2 sm:px-3 py-1 rounded-full">
                            Active
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 text-xs sm:text-sm flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="text-red-500 hover:text-red-400 p-2 hover:bg-red-500 hover:bg-opacity-10 rounded-lg transition-colors flex-shrink-0"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-lg border border-gray-700 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            >
              ...
              <div className="bg-blue-500 bg-opacity-10 border border-blue-500 rounded-lg p-3 sm:p-4">
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                <button
                  ...
                  className="flex-1 bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 sm:py-3 rounded-lg transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className={`flex-1 bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-2 sm:py-3 rounded-lg transition-colors ${
